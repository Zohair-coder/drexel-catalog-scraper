...
def send_request(url: str, method: str = "GET", json: dict = {}, headers: dict = {}):
    try:
        resp = send_request_helper(url, method, json, headers)
...
def send_request_helper(url: str, method: str, json: dict, headers: dict):
    timeout = 2
    if method == "GET":
